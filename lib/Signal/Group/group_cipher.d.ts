...
export class GroupCipher {
    ...
    getPlainText(iv: any, key: any, ciphertext: any): Promise<Uint8Array<ArrayBufferLike>>;
    getCipherText(iv: any, key: any, plaintext: any): Promise<Buffer<ArrayBufferLike>>;
}
