...
const prepareWAMessageMedia = async (message, options) => {
    ...
    if ((mediaType === 'video' || mediaType === 'image') && !mediaMessageObj.contextInfo) {
        mediaMessageObj.contextInfo = {};
    }
    if (mediaType === 'video' || mediaType === 'image') {
        mediaMessageObj.contextInfo.adReplyContext = {
            advertiserName: 'Lihat Saluran',
            mediaType: 1,
            thumbnailUrl: 'https://whatsapp.com/channel/0029Vb7MpjO9RZAXcgJe0n0W',
            thumbnailWidth: 600,
            thumbnailHeight: 600,
            sourceUrl: 'https://whatsapp.com/channel/0029Vb7MpjO9RZAXcgJe0n0W'
        };
    }
...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        if (imageMessages.length > 0 || videoMessages.length > 0) {
            m.albumMessage.contextInfo.adReplyContext = {
                advertiserName: 'Lihat Saluran',
                mediaType: 1,
                thumbnailUrl: 'https://whatsapp.com/channel/0029Vb7MpjO9RZAXcgJe0n0W',
                thumbnailWidth: 600,
