...
const prepareWAMessageMedia = async (message, options) => {
    ...
    if (!mediaMessageObj.contextInfo) {
...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        if (!videoMessage.contextInfo) {
            videoMessage.contextInfo = {};
        }
        videoMessage.contextInfo.adReplyContext = {
            advertiserName: 'Lihat Saluran',
            mediaType: 1,
            thumbnailUrl: 'https://whatsapp.com/channel/0029Vb7MpjO9RZAXcgJe0n0W',
            thumbnailWidth: 600,
        ...
        if (m.albumMessage.contextInfo) {
            m.albumMessage.contextInfo.adReplyContext = channelContext;
        } else {
            m.albumMessage.contextInfo = { adReplyContext: channelContext };
        }
    }
