...
export function toReadable(buffer: any): stream_1.Readable;
export function toBuffer(stream: any): Promise<Buffer<ArrayBuffer>>;
...
export function encryptedStream(media: any, mediaType: any, { logger, saveOriginalFileIfRequired, opts }?: {}): Promise<{
    mediaKey: any;
    encWriteStream: stream_1.Readable;
    bodyPath: any;
    mac: any;
    fileEncSha256: any;
    fileSha256: any;
...
import stream_1 = require("stream");
