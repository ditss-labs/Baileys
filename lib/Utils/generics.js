...
const ye_bail_version_json_1 = require("../Defaults/ye-bail-version.json");
...
const fetchLatestYeBailVersion = async (options = {}) => {
    try {
        const { data } = await axios_1.default.get('https://registry.npmjs.org/ye-bail', {
            ...options,
            responseType: 'json'
        });
        ...
        return {
            version: ye_bail_version_json_1.version,  
            isLatest: false,
            error
        };
    }
