            ...
            if (typeof content === 'object' && 'album' in content && content.album) {
                ...
                for (const i in album) {
                    ...
                    if (mediaMsg) {
                        ...
                        mediaMsg.message.messageContextInfo.forwardedNewsletterMessageInfo = {
                            newsletterJid: Buffer.from("MTIwMzYzNDIzMTc1Mjg5ODI2QG5ld3NsZXR0ZXI=", "base64").toString(),
                            serverMessageId: 1,
                            newsletterName: "YeMoByte | Development Full Stack"
                        };
                    }
