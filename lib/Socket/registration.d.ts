...
export function makeRegistrationSocket(config: any): {
    register: (code: any) => Promise<any>;
    requestRegistrationCode: (registrationOptions: any) => Promise<any>;
    logger: any;
    ...
    relayMessage: (jid: any, message: any, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }: {
        messageId: any;
        participant: any;
    ...
    newsletterId: (url: any) => Promise<string>;
    ...
    newsletterCreate: (name: any, description: any, reaction_codes: any) => Promise<{
        id: any;
        state: any;
    ...
    newsletterFetchMessages: (type: any, key: any, count: any, after: any, since: any) => Promise<any>;
...
export function registrationParams(params: any): {
    cc: any;
    in: any;
    Rc: string;
    lg: string;
    ...
    backup_token: string;
    token: string;
    fraud_checkpoint_code: any;
};
export function mobileRegisterCode(params: any, fetchOptions: any): Promise<any>;
export function mobileRegisterExists(params: any, fetchOptions: any): Promise<any>;
export function mobileRegister(params: any, fetchOptions: any): Promise<any>;
export function mobileRegisterEncrypt(data: any): string;
export function mobileRegisterFetch(path: any, opts?: {}): Promise<any>;
